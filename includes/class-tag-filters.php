...
class Tag_Filters
{
     ...
     * @since    1.0.0
     * @access   protected
     * @var      Tag_Filters_Loader $loader Maintains and registers all hooks for the plugin.
     */
    protected Tag_Filters_Loader $loader;
    ...
    {
        if (defined('TAG_FILTERS_VERSION')) {
            $this->version = TAG_FILTERS_VERSION;
        } else {
            $this->version = '1.0.0';
        }
        $this->plugin_name = 'tag-filters';
    ...
    private function load_dependencies()
    {
         ...
         * core plugin.
         */
        require_once plugin_dir_path(dirname(__FILE__)) . 'includes/class-tag-filters-loader.php';

        /**
         * The class responsible for defining internationalization functionality
         * of the plugin.
         */
        require_once plugin_dir_path(dirname(__FILE__)) . 'includes/class-tag-filters-i18n.php';

        /**
         * The class responsible for defining all actions that occur in the admin area.
         */
        require_once plugin_dir_path(dirname(__FILE__)) . 'admin/class-tag-filters-admin.php';
    ...
    private function define_public_hooks()
    {
        ...
        $this->loader->add_filter('template_include', $plugin_public, 'include_template_file');
     ...
     *
     * @return    Tag_Filters_Loader    Orchestrates the hooks of the plugin.
     * @since     1.0.0
     */
    public function get_loader(): Tag_Filters_Loader
    {
        return $this->loader;
    }
